...
export default function LogComponentSet() {
    ...
    return (
        <div className="my-[20vh] rounded-3xl bg-opacity-10 bg-gray-800 w-[70vw] mx-auto logborder">
            {logs.map(log => (
...
export function LogCard({ log }: { log: { title: string, content: ReactNode, date: string, id: number } }) {
    return (
        <div id={log.id.toString()} className="relative h-[30vh] w-[70vw] mx-auto hover:shadow-xl duration-300">
