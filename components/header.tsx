...
export function Header({ setIsMute, isMute, haveVolumeControl }: { setIsMute: Dispatch<SetStateAction<boolean>>, isMute: boolean, haveVolumeControl: boolean }) {
    return (
        <div className="">
            <header className="headerHoverTrans fixed top-3 flex flex-row md:h-16 h-12 bg-gray-800 duration-300 text-gray-400 items-center md:p-4 p-3 w-[96%] mx-[2%] rounded-3xl Header-extra opacity-0 hover:opacity-50">
                ...
                <div className="ml-auto flex space-x-4 place-items-center">
                    ...
                    <NavigatorText text="仓库" onClick={repoOnClick} path='/repo' />
                    <NavigatorText text="赞助" onClick={donateOnClick} path='/donate' />
                    <NavigatorText text="关于" onClick={aboutOnClick} path='/about' />
