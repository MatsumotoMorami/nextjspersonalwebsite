...
function NavigatorText({ text, path }: { text: string | ReactNode, path: string }) {
...
function NavigatorIcon({ svg, path }: { svg: ReactNode, onClick: MouseEventHandler<HTMLDivElement>, path: string }) {
    return (
        <Link className="cursor-pointer hover:text-white duration-200 pr-2" href={path}>
            {svg}
        </Link>
    );
}
        ...
        <div className="">
            <header className={hoverVisible
                ...
                <div className="ml-auto flex space-x-4 place-items-center">
                    <NavigatorText text="首页" path='/home' />
                    <NavigatorText text="简介" path='/intro' />
                    <NavigatorText text="博客" path='/blog' />
                    <NavigatorText text="日志" path='/logs' />
                    <NavigatorText text="赞助" path='/donate' />
                    <NavigatorText text="关于" path='/about' />
                    <NavigatorIcon onClick={() => { }} path="/friends" svg={<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="lg:size-5 size-3">
                        <path fillRule="evenodd" d="M19.902 4.098a3.75 3.75 0 0 0-5.304 0l-4.5 4.5a3.75 3.75 0 0 0 1.035 6.037.75.75 0 0 1-.646 1.353 5.25 5.25 0 0 1-1.449-8.45l4.5-4.5a5.25 5.25 0 1 1 7.424 7.424l-1.757 1.757a.75.75 0 1 1-1.06-1.06l1.757-1.757a3.75 3.75 0 0 0 0-5.304Zm-7.389 4.267a.75.75 0 0 1 1-.353 5.25 5.25 0 0 1 1.449 8.45l-4.5 4.5a5.25 5.25 0 1 1-7.424-7.424l1.757-1.757a.75.75 0 1 1 1.06 1.06l-1.757 1.757a3.75 3.75 0 1 0 5.304 5.304l4.5-4.5a3.75 3.75 0 0 0-1.035-6.037.75.75 0 0 1-.354-1Z" clipRule="evenodd" />
                    </svg>} />
                    {<NavigatorIcon onClick={() => { }} path="/state" svg={<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="lg:size-5 size-3">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M5.25 14.25h13.5m-13.5 0a3 3 0 0 1-3-3m3 3a3 3 0 1 0 0 6h13.5a3 3 0 1 0 0-6m-16.5-3a3 3 0 0 1 3-3h13.5a3 3 0 0 1 3 3m-19.5 0a4.5 4.5 0 0 1 .9-2.7L5.737 5.1a3.375 3.375 0 0 1 2.7-1.35h7.126c1.062 0 2.062.5 2.7 1.35l2.587 3.45a4.5 4.5 0 0 1 .9 2.7m0 0a3 3 0 0 1-3 3m0 3h.008v.008h-.008v-.008Zm0-6h.008v.008h-.008v-.008Zm-3 6h.008v.008h-.008v-.008Zm0-6h.008v.008h-.008v-.008Z" />
                    </svg>} />}
                    {haveVolumeControl ? <NavigatorIcon path='' onClick={() => muteOnClick(setIsMute)} svg={isMute ? <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="lg:size-5 size-3">
